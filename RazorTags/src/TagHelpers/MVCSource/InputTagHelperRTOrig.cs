...
//{
//	// We REMOVE the HtmlTargetElement because the intent is to only use this by other tags
//	//[HtmlTargetElement("inputdd", Attributes = ForAttributeName, TagStructure = TagStructure.WithoutEndTag)]
//	public abstract class InputTagHelperRT : TagHelper
//	{
//		public const string ForAttributeName = "asp-for";
//		public const string FormatAttributeName = "asp-format";

//		// Mapping from datatype names and data annotation hints to values for the <input/> element's "type" attribute.
//		public static readonly Dictionary<string, string> _defaultInputTypes =
...
//		public static readonly Dictionary<string, string> _rfc3339Formats =
...
//		public InputTagHelperRT(IHtmlGenerator generator)
//		{
//			Generator = generator;
//		}
...
//			if (metadata == null) {
//				InputTagHelperRTX.ThrowExOnMetadataNull(ForAttributeName, For.Name);
...
//		public string GetInputType(ModelExplorer modelExplorer, out string inputTypeHint)
//		{
...
//		public TagBuilder GenerateCheckBox(ModelExplorer modelExplorer, TagHelperOutput output)
//		{
...
//				InputTagHelperRTX.ThrowExOnInvalidModelTypeShouldBeBool();
...
//		public TagBuilder GenerateRadio(ModelExplorer modelExplorer)
//		{
//			// Note empty string is allowed.
//			if (Value == null) {
//				InputTagHelperRTX.ThrowExOnValueRequired();
...
//		public TagBuilder GenerateTextBox(ModelExplorer modelExplorer, string inputTypeHint, string inputType)
//		{
//			var format = Format;
...
//		public TagBuilder GenerateHidden(ModelExplorer modelExplorer)
//		{
//			var value = For.Model;
...
//		public string GetFormat(ModelExplorer modelExplorer, string inputTypeHint, string inputType)
//		{
//			string format;
